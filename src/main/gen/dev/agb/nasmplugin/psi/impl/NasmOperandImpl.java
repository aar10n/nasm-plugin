...
public class NasmOperandImpl extends ASTWrapperPsiElement implements NasmOperand {
  ...
  @Override
  @NotNull
  public List<NasmDecorator> getDecoratorList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NasmDecorator.class);
  }

  @Override
  @Nullable
  public NasmExpandedOperand getExpandedOperand() {
    return findChildByClass(NasmExpandedOperand.class);
  }
